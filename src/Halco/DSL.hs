...
import           Halco.Conts  (InCont, OutCont, OutCont1, OutCont2)
...
infix 1 `ap0`
ap0 :: OutCont s o
    => NodeName -> o -> (NodeName, CSource s o)
ap0 nn o = (nn, CSource o)

infix 1 `ap1`
ap1 :: (InCont s i, OutCont1 s o)
    => NodeName -> (i, o) -> (NodeName, COp1 s i o)
ap1 nn (i, o) = (nn, COp1 i o)

infix 1 `ap2`
ap2 :: (InCont s i, OutCont2 s o)
    => NodeName -> ((i, i), o) -> (NodeName, COp2 s i o)
